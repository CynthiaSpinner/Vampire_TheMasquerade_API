...
('Toreador', 'Artists and hedonists who appreciate beauty. Socialites and aesthetes.', 'Aesthetic Fixation: Must make a Resolve + Composure roll or be captivated by beauty, losing focus.', 'Melancholy: Falls into depression when art is destroyed or beauty is lost.', 'Social', '[7, 9, 13]', 'Camarilla'),
...
('Ventrue', 'Nobles and leaders who command respect. Corporate executives and aristocrats.', 'Feeding Restriction: Can only feed from specific types of mortals (e.g., only virgins, only criminals).', 'Arrogance: Must assert dominance when challenged, cannot back down from confrontations.', 'Social', '[8, 9, 13]', 'Camarilla'),
